...
from business_register.serializers.company_serializers import (CountFoundedCompaniesSerializer,
...
class CompanyDetailLinkWithPepSerializer(serializers.ModelSerializer):
...
class PepDetailSerializer(serializers.ModelSerializer):
    ...
    def get_related_companies(self, obj):
        ...
        return CompanyDetailLinkWithPepSerializer(queryset, many=True).data
