...
PEP_PROD_TUNNEL_TIMEOUT = 5.0
PEP_PROD_SSH_TIMEOUT = 5.0
PEP_PROD_SSH_SERVER_IP = ''
PEP_PROD_SSH_SERVER_PORT = 22
PEP_PROD_SSH_USERNAME = ''
PEP_PROD_SSH_PKEY = ''
PEP_PROD_DB_SERVER_IP = ''
PEP_PROD_DB_SERVER_PORT = 5432
PEP_PROD_DB_NAME = ''
PEP_PROD_DB_USER = ''
PEP_PROD_DB_PASSWORD = ''
# PEP_PROD_MAP_DB_SERVER_IP = '0.0.0.0'
# PEP_PROD_MAP_DB_SERVER_PORT = 8080
