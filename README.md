...
-----------------------------------------------------------------------------------------------------
Export files to AWS S3
-----------------------------------------------------------------------------------------------------
Source: https://boto3.amazonaws.com/

Before using Boto3, you need to set up authentication credentials for your AWS account using either the IAM Console 
https://console.aws.amazon.com/iam/home or the AWS CLI. You can either choose an existing user or create a new one.

For instructions about how to create a user using the IAM Console, see
https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html#id_users_create_console.
Once the user has been created, see
https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html#Using_CreateAccessKey
to learn how to create and retrieve the keys used to authenticate the user.

If you have the AWS CLI installed http://aws.amazon.com/cli/, then you can use the aws configure command to configure
...
At a minimum, the credentials file should specify the access key and secret access key. In this example, the key and
secret key for the account are specified the default profile:
...
You can also add a default region to the AWS configuration file, which is located by default at
- ~/.aws/config:
...
You have now configured credentials for the default profile as well as a default region to use when creating
connections. 
